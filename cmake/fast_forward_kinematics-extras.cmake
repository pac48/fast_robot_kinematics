function(generate_fast_forward_kinematics_library URDF_FILE ROOT_LINK TIP_LINK)
    ...
    add_library(fast_forward_kinematics_library SHARED forward_kinematics_lib.cpp ${CMAKE_SOURCE_DIR}/src/fast_kinematics.cpp ${CMAKE_SOURCE_DIR}/src/fast_inverse_kinematics.cpp)
    ...
    target_compile_definitions(fast_forward_kinematics_library PUBLIC "${FAST_FK_NUMBER_OF_JOINTS}" FAST_FK_USE_IK)
