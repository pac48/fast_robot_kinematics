...
requires KinematicInterfaceConstraint<KI> && ForwardKinematicInterfaceConstraint<KI>
struct ForwardKinematicsInterface : KI
{
};

template <typename IK>
requires KinematicInterfaceConstraint<IK> && ForwardKinematicInterfaceConstraint<IK> &&
